...
by that time, the Windodws 11 installer was in the middle of downloading and i closed WinBoot thinking that the next time i opened it, it would start over
